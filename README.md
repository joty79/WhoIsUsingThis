...
**From context menu** — *Right-click any file or folder → System Tools → Windows → Who is using this?*
...
- Registers context menu entries under **System Tools → Windows**:
  - `*\shell\SystemTools\shell\Windows\shell\WhoIsUsingThis` — files
  - `Directory\shell\SystemTools\shell\Windows\shell\WhoIsUsingThis` — folders
